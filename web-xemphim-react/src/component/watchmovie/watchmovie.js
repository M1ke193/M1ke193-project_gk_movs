        ...
        <div className="watch-movie">
            <div className="watch-movie-cover">
                <div className="watch-movie-play">
                    {state.index == null ?
                        <iframe className="custom-video-watch-movie" src={'https://embed.smashystream.com/playere.php?tmdb=' + state.id} frameBorder="0" allowFullScreen title="Movie" aria-hidden="true" /> :
                        <iframe className="custom-video-watch-movie" src={'https://embed.smashystream.com/playere.php?tmdb=' + state.id + '&season=' + state.index + '&episode=' + e} frameBorder="0" allowFullScreen title="TV" aria-hidden="true" />
                    }
                </div>
